...
public class StringClass1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("c1:"+c1);
		 ...
		 System.out.println("s1char count"+s1.length());
		 System.out.println("s2char count"+s2.length());
